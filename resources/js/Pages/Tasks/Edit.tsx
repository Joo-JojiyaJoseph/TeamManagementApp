...
export default function EditTask() {
    const { task, projects, employees } = usePage<any>().props;
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.put(route('tasks.update', taskData.id), submitData, {
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Link href={route('tasks.show', taskData.id)} className="px-4 py-2 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400">Cancel</Link>
                            </div>
                        </form>
                    </div>
                </div>
